...
/*!**************************!*\
  !*** ./src/apis/auth.ts ***!
  \**************************/
/*! exports provided: googleAuthRequest */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"googleAuthRequest\", function() { return googleAuthRequest; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"axios\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\nconst googleAuth = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create({\n  baseURL: 'https://accounts.google.com/o/oauth2/v2/auth/'\n});\n\nconst request = async config => {\n  try {\n    const {\n      data\n    } = await googleAuth.request(config);\n    return [undefined, data];\n  } catch (error) {\n    return [error, undefined];\n  }\n};\n\nconst GET = (url, params, config) => request({ ...config,\n  method: \"GET\",\n  url,\n  params\n});\n\nconst googleAuthRequest = () => GET('', {\n  client_id: process.env.CLIENT_ID,\n  redirect_uri: process.env.CLIENT_SECRET,\n  response_type: 'token&',\n  scope: 'openid profile email'\n});\n\n//# sourceURL=webpack:///./src/apis/auth.ts?");
...
/*!***************************!*\
  !*** ./src/sagas/user.ts ***!
  \***************************/
/*! exports provided: loginSaga */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loginSaga\", function() { return loginSaga; });\n/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-saga/effects */ \"redux-saga/effects\");\n/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _store_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/user */ \"./src/store/user.ts\");\n/* harmony import */ var _apis_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../apis/auth */ \"./src/apis/auth.ts\");\n\n\n\n\nconst {\n  takeLatest,\n  put,\n  call,\n  all,\n  fork,\n  delay\n} = redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__;\n\nfunction* fetchLogin() {\n  yield console.log(\"fetchLogin dispatched\");\n\n  try {\n    yield put(Object(_store_user__WEBPACK_IMPORTED_MODULE_1__[\"LoginLoading\"])());\n    const result = yield call(_apis_auth__WEBPACK_IMPORTED_MODULE_2__[\"googleAuthRequest\"]);\n    yield console.log(result);\n    yield put(Object(_store_user__WEBPACK_IMPORTED_MODULE_1__[\"LoginSuccess\"])());\n  } catch (e) {\n    throw new Error(e);\n  }\n}\n\nfunction* fetchLoginWatcher() {\n  yield takeLatest(_store_user__WEBPACK_IMPORTED_MODULE_1__[\"LOGIN_ENUM\"].LOGIN_FETCH, fetchLogin);\n}\n\nfunction* loginSaga() {\n  yield fork(fetchLoginWatcher);\n}\n\n//# sourceURL=webpack:///./src/sagas/user.ts?");
